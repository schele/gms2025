...
namespace GMS2025.Business.Generators
{
            ...
            foreach (TypeModel typeModel in builder.GetModelsToGenerate())
            {
                ...
                if (typeModel.IsElement == false && typeModel.ItemType == TypeModel.ItemTypes.Content && result.Contains(": PublishedContentModel"))
                {
                    result = result
                        ...
                        .Replace("using Umbraco.Extensions;", "using Umbraco.Extensions;" + Environment.NewLine + "using Umbraco.Cms.Core.Web;" + Environment.NewLine + "using GMS2025.Models;");
                }
